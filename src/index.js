...
async function resetMap() {
  ...
  platforms = [
    ...
    new Platform(context, canvas, {x: platformImage.width * 4 + 380 + platformImage.width - smallPlatformImage.width, y: 290, image: smallPlatformImage, block: true}),
    new Platform(context, canvas, {x: -1, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width - 3, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 2 + 200, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 3 + 380, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 4 + 380, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 5 + 780, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 6 + 780, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 7 + 1100, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 8 + 1600, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 9 + 2000, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 10 + 2550, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 11 + 3000, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 12 + 3850, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 13 + 3850, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: platformImage.width * 14 + 3850, y: 460, image: platformImage, block: true}),
    new Platform(context, canvas, {x: 3080, y: 290, image: smallPlatformImage, block: true}),
    new Platform(context, canvas, {x: 5655, y: 290, image: smallPlatformImage, block: true}),
    new Platform(context, canvas, {x: 6740, y: 290, image: smallPlatformImage, block: true}),
    new Platform(context, canvas, {x: 9060, y: 290, image: smallPlatformImage, block: true}),
    new Platform(context, canvas, {x: 10100, y: 290, image: smallPlatformImage, block: true}),
